function [best_path, full_path, best_cost, cost_history] = uav_path_planning(buildings, start_point, end_point, params)
    if nargin < 4
        params = struct();
    end
    ...
    [best_path, best_cost, best_generation, cost_history] = genetic_algorithm(params, buildings, start_point, end_point);
